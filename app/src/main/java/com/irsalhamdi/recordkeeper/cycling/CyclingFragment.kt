...
class CyclingFragment: Fragment() {
    ...
    private fun setupOnClickListener() {
        ...
        binding.containerBestSpeed.setOnClickListener { launchCyclingRecordScreen("Best Average Speed") }
    }

    private fun launchCyclingRecordScreen(category: String) {
        val intent = Intent(context, EditCyclingActivity::class.java)
